...
"""Run Vane TPC-H benchmarks using the NativeRunner (Relation API).

This is the native counterpart of `run_tpch_vane_ray_relapi.py`.
...
Usage:
    ...
    python benchmarking/tpch/run_tpch_vane_native_relapi.py \
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run Vane TPC-H benchmarks using NativeRunner (Relation API) with per-query timeouts"
    )
