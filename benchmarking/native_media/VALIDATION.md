...
The [2026-09-06 report](https://github.com/AstroVela/vane/blob/4e12994a2fed5b872a7bdb44df72c1b9c5653cdc/benchmarking/native_media/VALIDATION.md)
retains the measured source revisions, environments, input identities and results.
Use the instructions above for new runs; historical timings do not describe the
current checkout.
