...
void register_ray_bindings(py::module_ &mod) {
	...
	py::class_<PyPhysicalPlanWrapper>(m, "DistributedPhysicalPlan")
	    ...
	    .def("collect_execution_stages", &PyPhysicalPlanWrapper::collect_execution_stages,
	         py::arg("conn") = py::none())
	...
	py::class_<PyPhysicalPlanWrapperRunner>(m, "DistributedPhysicalPlanRunner")
	    ...
	    .def(
	        ...
	        py::arg("fte_exchange_source_queues") = py::none(),
	        py::arg("dynamic_filter_domains") = py::none(), py::arg("native_progress_callback") = py::none(),
	        py::arg("runtime_context") = py::none(),
	...
	m.def(
	    ...
	    py::arg("handle"),
	    "Verify PythonTaskResultHandle can poll a backend-neutral Python handle.");
		...
		m.def(
		    ...
		    [](const std::string &base_path,
		       ...
		       const std::string &file_name) {
			    ...
			    py::dict out;
			    out["direct_target_file"] =
			        BuildCopyDirectTargetFilePath(base_path, run_id, worker_dir_name, file_name);
			    out["legacy_task_directory"] =
			        BuildCopyDirectWriteTaskDirectory(base_path, run_id, worker_dir_name);
