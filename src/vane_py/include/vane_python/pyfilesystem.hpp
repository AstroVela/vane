...
public:
	static bool check_(const py::handle &object) {
		return py::isinstance(object, py::module::import("vane.filesystem").attr("ModifiedMemoryFileSystem"));
	}
};
...
public:
	...
	//! release the GIL. Same-thread reentry must fail rather than move the
	//! position underneath the outer operation.
	class Operation {
	public:
