...
from duckdb._ray_progress_env import configure_ray_progress_logging_defaults, ray_log_to_driver_default
...
from duckdb.runners.ray.partition_metadata import (  # noqa: F401 — re-export for consumers
    PartitionMetadata,
