...
public:
	...
	OpenFileInfo file;
	//! (Optionally) The file index. Readers for explicit distributed splits may
	//! pre-set the stable coordinator index; otherwise the multi-file reader
	//! assigns the active file-list index during initialization.
