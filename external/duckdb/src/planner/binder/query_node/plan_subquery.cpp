...
static unique_ptr<Expression> PlanUncorrelatedSubquery(Binder &binder, BoundSubqueryExpression &expr,
	...
	case SubqueryType::EXISTS: {
		...
		// These functions are generated by the engine, not selected from the catalog.
		// The subquery's user expressions already passed the binder's source policy.
	...
	case SubqueryType::SCALAR: {
		...
		// Bind only the engine's fixed FIRST/COUNT/error implementations here.
		FunctionBinder function_binder(binder.context);
		auto first_agg =
