...
class DuckDBPyConnection:
    ...
    def execute(self, query: Statement | str, parameters: object = None) -> DuckDBPyConnection:
        """Execute SELECT through Ray when configured, or native DuckDB with local-fast.

        Other SQL statements execute on the connection. Ray SELECT requires auto-commit.
        """
        ...
...
class Expression:
    ...
    def resize(self, w: int | Expression | None, h: int | Expression | None) -> Expression: ...
