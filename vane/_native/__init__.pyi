...
class DuckDBPyConnection:
    ...
    def _compare_and_record_dynamic_extension_snapshot_entry(self, expected_entries: list[str], entry: str) -> bool: ...
    def _export_dynamic_extension_snapshot_entries(self) -> list[str]: ...
    ...
    def _read_video_frames(self, parameters: object, options: dict[str, object]) -> DuckDBPyRelation: ...
    def tensor_type(
        self, type: sqltypes.DuckDBPyType, shape: Sequence[typing.SupportsInt | None]
    ) -> sqltypes.DuckDBPyType: ...
...
class DuckDBPyRelation:
    ...
    def create(
        ...
        table_name: str,
        *,
        properties: typing.Mapping[str, _ExpressionLike] | None = None,
        partition_by: typing.Sequence[Expression | str] | None = None,
    ) -> None: ...
    ...
    def delete(self, *, condition: _ExpressionLike | None = None) -> None: ...
    ...
    def _validate_datasink_retry_input(self) -> None: ...
    ...
    def _run_datasink(self) -> dict[str, typing.Any]: ...
    def map(
        self,
    ...
    def to_file(self, file_name: str, *, format: str) -> None: ...
    def to_parquet(
        self,
        file_name: str,
        *,
    ...
    def write_file(self, file_name: str, *, format: str) -> None: ...
    def write_parquet(
        self,
        file_name: str,
        *,
...
class Expression:
    ...
    def as_image(self, mode: str | None = None, height: int | None = None, width: int | None = None) -> Expression: ...
    def image_attribute(self, name: str | Expression) -> Expression: ...
    def crop(self, bbox: tuple[int, int, int, int] | list[int] | Expression) -> Expression: ...
    def encode_image(self, image_format: str | Expression) -> Expression: ...
    def resize(
        self,
        w: int | Expression | None,
        h: int | Expression | None,
        *,
        antialias: bool | np.bool_ | Expression | None = False,
    ) -> Expression: ...
    def convert_image(self, mode: str | Expression | None) -> Expression: ...
    ...
    def file_mime_type(self, detect: str | Expression = "metadata") -> Expression: ...
    def file_path(self) -> Expression: ...
    def file_size(self) -> Expression: ...
    def file_stat(self) -> Expression: ...
    def audio_metadata(self, *, max_bytes: int | Expression = 8388608) -> Expression: ...
    def decode_image(
        self, on_error: str | Expression = "raise", mode: str | Expression | None = "RGB"
    ) -> Expression: ...
    def image_hash(
        self, *, method: str = "phash", hash_size: int = 8, binbits: int = 3, segments: int = 3
    ) -> Expression: ...
    def decode_image_file(
        self,
        mode: str | Expression | None = None,
        on_error: str | Expression = "raise",
        *,
        max_input_bytes: int | Expression = 268435456,
        max_pixels: int | Expression = 100000000,
        max_decoded_bytes: int | Expression = 536870912,
    ) -> Expression: ...
    ...
    @property
    def checksum(self) -> Expression: ...
    @property
    def content_type(self) -> Expression: ...
    @property
    def position(self) -> Expression: ...
    @property
    def size(self) -> Expression: ...
    @property
    def url(self) -> Expression: ...
...
class File:
    ...
    def exists(self, *, connection: DuckDBPyConnection | None = None) -> bool: ...
    def mime_type(self, detect: str = "metadata", *, connection: DuckDBPyConnection | None = None) -> str | None: ...
    def open(
        self, buffer_size: int | None = None, *, connection: DuckDBPyConnection | None = None
    ) -> VaneFileReader: ...
    def stat(self, *, connection: DuckDBPyConnection | None = None) -> FileStat: ...
    ...
    def to_tempfile(
        self, buffer_size: int = 1048576, *, connection: DuckDBPyConnection | None = None
    ) -> typing.BinaryIO: ...
    @property
...
class _DataSourceExecutionContext:
    ...
    def _capture_video_error(self, error: BaseException) -> None: ...
...
def _verify_native_runtime_signature(contents: bytes, signature: bytes, allow_community: bool = False) -> bool: ...
def _dynamic_extension_canonical_name(extension: str) -> str: ...
def _dynamic_extension_directory(*, connection: DuckDBPyConnection) -> str: ...
def _dynamic_extension_compatibility_version() -> str: ...
def _dynamic_extension_platform() -> str: ...
def _dynamic_extension_cache_path_is_replaceable(path: str) -> bool: ...
def _secure_dynamic_extension_cache_path(path: str, *, directory: bool) -> None: ...
def _inspect_dynamic_extension(path: str) -> dict[str, str]: ...
def _load_dynamic_extension(path: str, *, connection: DuckDBPyConnection) -> dict[str, str]: ...
def _loaded_dynamic_extension(extension: str, *, connection: DuckDBPyConnection) -> dict[str, str] | None: ...
def _open_file_reader(
    file: File, *, buffer_size: int, connection: DuckDBPyConnection | None = None
) -> _VaneFileReaderHandle: ...
def _open_file_reader_in_datasource_context(
    file: File, *, buffer_size: int, execution_context: _DataSourceExecutionContext
) -> _VaneFileReaderHandle: ...
def _parse_serialized_logical_type(type_str: str) -> sqltypes.DuckDBPyType: ...
...
def file_type(media_type: MediaType = ...) -> sqltypes.DuckDBPyType: ...
def image_type(
    mode: str | None = None, height: int | None = None, width: int | None = None
) -> sqltypes.DuckDBPyType: ...
...
def tensor_type(
    type: sqltypes.DuckDBPyType,
    shape: Sequence[typing.SupportsInt | None],
    *,
    connection: DuckDBPyConnection | None = None,
) -> sqltypes.DuckDBPyType: ...
