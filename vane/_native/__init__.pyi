...
class Expression:
    ...
    def file_mime_type(self, detect: str = "metadata") -> Expression: ...
...
class File:
    ...
    def exists(self, *, connection: DuckDBPyConnection | None = None) -> bool | None: ...
    ...
    def stat(self, *, connection: DuckDBPyConnection | None = None) -> dict[str, object]: ...
    def to_tempfile(
