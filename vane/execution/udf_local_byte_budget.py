...
def local_byte_budget_state(
    ...
    *,
    ...
    limit = limits.max_bytes if limit_bytes is None else min(limits.max_bytes, limit_bytes)
    ...
    reserved = allocate_resource_reservations(
        ...
        {key: limit for key in eligible_units},
        limit=max(0, limit - inactive_usage),
...
def local_task_budget_block_reason(
    ...
    if budget.query_usage_bytes + limits.task_bytes > budget.limit_bytes:
        return "total_bytes"
