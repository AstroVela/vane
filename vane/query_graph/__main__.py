...
thead {
  background-color: var(--vane-accent);
  color: white;
}
...
class ProfilingInfo:  # noqa: D101
    ...
    <body>
        <div class="container">
            <header>
                <img src="https://raw.githubusercontent.com/vane/vane/refs/heads/main/logo/DuckDB_Logo-horizontal.svg" alt="DuckDB Logo">
