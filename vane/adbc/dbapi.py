...
"""DBAPI 2.0-compatible facade for Vane's ADBC driver."""
...
def connect(path: str | None = None, **kwargs: Any) -> adbc_driver_manager.dbapi.Connection:
    """Connect to Vane via ADBC."""
    db = None
    conn = None

    try:
        db = adbc.connect(path)
