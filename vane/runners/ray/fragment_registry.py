...
from vane.runners.fte.fte_scheduler import FteSchedulerRegistry
...
class FteRegistryState:
    fragment_plan_ref_cache: dict[tuple[str, str, str], ray.ObjectRef[Any]] = field(default_factory=dict)
