...
from vane.runners.common import PartitionMetadata as PartitionMetadata
...
class RayMaterializedResult(MaterializedResult):
    ...
    def partition_ref(self) -> ray.ObjectRef[Any]:
...
class PartitionMetadataAccessor:
    ...
    def __init__(self, ref: ray.ObjectRef[list[PartitionMetadata]]) -> None:
        self._ref = ref
