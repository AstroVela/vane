...
def _check_sdist(artifact: SdistArtifact) -> None:
    ...
    required_paths = (
        ...
        "external/duckdb/.github/config/extensions/avro.cmake",
        "external/duckdb/.github/config/extensions/iceberg.cmake",
        ...
        "tests/fast/data/iceberg_equality_deletes.tar.gz.b64",
        "tests/fast/data/iceberg_nested_defaults.tar.gz.b64",
        "tests/fast/data/iceberg_partition_integer.tar.gz.b64",
        "tests/fast/data/iceberg_partition_spec_evolution.tar.gz.b64",
        "tests/fast/data/iceberg_positional_deletes.tar.gz.b64",
        "tests/fast/data/iceberg_schema_evolution.tar.gz.b64",
        "tests/fast/data/iceberg_struct_filter.tar.gz.b64",
        "tests/fast/data/iceberg_unknown_puffin.tar.gz.b64",
        "tests/fast/data/iceberg_uuid.tar.gz.b64",
        "tests/fast/test_distributed_iceberg.py",
        "tests/fast/test_distributed_iceberg_rest.py",
        "tests/helpers/iceberg_rest_commit_failure_proxy.py",
