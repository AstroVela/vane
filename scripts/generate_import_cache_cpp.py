...
//                         DuckDB
//
// vane_python/import_cache/modules/{self.file_name}
//
//
//===----------------------------------------------------------------------===//
...
//! Note: This file is automatically generated using scripts.
...
for file in files:
    ...
    path = f"src/vane_py/include/vane_python/import_cache/modules/{file.file_name}"
...
//! Note: This file is automatically generated using scripts/generate_import_cache_cpp.py.
...
import_cache_path = Path(script_dir) / ".." / "src/vane_py/include/vane_python/import_cache/python_import_cache.hpp"
import_cache_path.write_text(import_cache_file)


def get_module_file_path_includes(files: list[ModuleFile]):
    template = '#include "vane_python/import_cache/modules/{}"'
...
modules_header = (
    Path(script_dir) / ".." / ("src/vane_py/include/vane_python/import_cache/python_import_cache_modules.hpp")
)
