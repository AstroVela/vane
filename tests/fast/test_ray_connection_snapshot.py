...
def test_connection_snapshot_captures_exact_extension_contract():
    ...
    assert snapshot["distributed_extension_contracts"] == [
        ...
        "table_function:read_json(VARCHAR)@1,"
        "table_function:read_json(VARCHAR[])@1,"
        "table_function:read_json_auto(VARCHAR)@1,"
        "table_function:read_json_auto(VARCHAR[])@1,"
        "table_function:read_json_objects(VARCHAR)@1,"
        "table_function:read_json_objects(VARCHAR[])@1,"
        "table_function:read_json_objects_auto(VARCHAR)@1,"
        "table_function:read_json_objects_auto(VARCHAR[])@1,"
        "table_function:read_ndjson(VARCHAR)@1,"
        "table_function:read_ndjson(VARCHAR[])@1,"
        "table_function:read_ndjson_auto(VARCHAR)@1,"
        "table_function:read_ndjson_auto(VARCHAR[])@1,"
        "table_function:read_ndjson_objects(VARCHAR)@1,"
        "table_function:read_ndjson_objects(VARCHAR[])@1}",
