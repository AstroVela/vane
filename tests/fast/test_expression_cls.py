...
def test_vane_cls_public_api_and_import_guard(monkeypatch):
    import duckdb
    import vane
    ...
    sys.modules.pop("vane.cls", None)
    with pytest.raises(ModuleNotFoundError, match=r"No module named 'vane\.cls'"):
        importlib.import_module("vane.cls")
