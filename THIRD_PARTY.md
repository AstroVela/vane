...
| Apache Arrow ADBC DuckDB driver facade | Python ADBC facade adapted to load Vane's private native driver | Apache-2.0 | ASF license notices retained in `vane/adbc/` and the repository `LICENSE` |
